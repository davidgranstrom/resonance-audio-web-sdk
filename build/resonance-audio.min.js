 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(8),n=e(0);function s(A){let t={};for(let e in n.DEFAULT_ROOM_MATERIALS)n.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&(t[e]=n.ROOM_MATERIAL_COEFFICIENTS[n.DEFAULT_ROOM_MATERIALS[e]]);void 0==A&&(A={},Object.assign(A,n.DEFAULT_ROOM_MATERIALS));for(let e in n.DEFAULT_ROOM_MATERIALS)n.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&A.hasOwnProperty(e)?A[e]in n.ROOM_MATERIAL_COEFFICIENTS?t[e]=n.ROOM_MATERIAL_COEFFICIENTS[A[e]]:n.log('Material "'+A[e]+'" on wall "'+e+'" not found. Using "'+n.DEFAULT_ROOM_MATERIALS[e]+'".'):n.log('Wall "'+e+'" is not defined. Default used.');return t}function o(A){void 0==A&&(A={});for(let t in n.DEFAULT_ROOM_DIMENSIONS)A.hasOwnProperty(t)||(A[t]=n.DEFAULT_ROOM_DIMENSIONS[t]);return A}function r(A){let t=[];for(let e in n.DEFAULT_REFLECTION_COEFFICIENTS)if(n.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)){t[e]=0;for(let i=0;i<n.NUMBER_REFLECTION_AVERAGING_BANDS;i++){let s=i+n.ROOM_STARTING_AVERAGING_BAND;t[e]+=A[e][s]}t[e]/=n.NUMBER_REFLECTION_AVERAGING_BANDS,t[e]=Math.sqrt(1-t[e])}return t}function a(A,t){void 0==t&&(t={}),void 0==t.listenerPosition&&(t.listenerPosition=n.DEFAULT_POSITION.slice()),void 0==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,n.DEFAULT_ROOM_DIMENSIONS)),void 0==t.materials&&(t.materials={},Object.assign(t.materials,n.DEFAULT_ROOM_MATERIALS)),void 0==t.speedOfSound&&(t.speedOfSound=n.DEFAULT_SPEED_OF_SOUND),t.dimensions=o(t.dimensions);let e=r(s(t.materials));this.early=new i(A,{dimensions:t.dimensions,coefficients:e,speedOfSound:t.speedOfSound,listenerPosition:t.listenerPosition}),this.speedOfSound=t.speedOfSound,this.output=A.createGain(),this.early.output.connect(this.output)}a.prototype.setProperties=function(A,t){let e=s(t);this.early.speedOfSound=this.speedOfSound;let i=r(e);this.early.setRoomProperties(A,i)},a.prototype.setListenerPosition=function(A,t,e){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(A,t,e);let i=this.getDistanceOutsideRoom(A,t,e),s=1;i>n.EPSILON_FLOAT&&(s=1-i/n.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,s=Math.max(0,Math.min(1,s))),this.output.gain.value=s},a.prototype.getDistanceOutsideRoom=function(A,t,e){let i=Math.max(0,-this.early._halfDimensions.width-A,A-this.early._halfDimensions.width),n=Math.max(0,-this.early._halfDimensions.height-t,t-this.early._halfDimensions.height),s=Math.max(0,-this.early._halfDimensions.depth-e,e-this.early._halfDimensions.depth);return Math.sqrt(i*i+n*n+s*s)},A.exports=a},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
